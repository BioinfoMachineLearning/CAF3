...
from template_search import residue_constants
from template_search import mmcif_parsing
from template_search import parsers
from template_search import kalign
import numpy as np
import copy
  ...
  """
    ...
    try:
        ...
        try:
            ...
            # logging.warning("end_realign")
            # logging.warning(f"{seqres},{mapping}")
        except Exception as e:
            logging.error(">>> REALIGN FAILED with exception: %s", repr(e))
        ...
        warning = (
            ...
            f'{pdb_id}_{chain_id}. Realigningggg the template to the actual sequence.')
        logging.warning(warning)

        # logging.info("start_realign")
        # # This throws an exception if it fails to realign the hit.
        # seqres, mapping = _realign_pdb_template_to_query(
        #     old_template_sequence=template_sequence,
        #     template_chain_id=template_chain_id,
    ...
    # logging.warning(f'{pdb_id.lower()}_{chain_id}'.encode(),output_templates_sequence.encode())
    return (
        {
